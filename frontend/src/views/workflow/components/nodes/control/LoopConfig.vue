<template>
  ...
  >
    ...
    <el-form-item
      v-if="config.loopType === 'collection'"
      label="集合变量"
    >
      <el-input
        v-model="config.collectionVar"
        placeholder="例如: items"
      />
    </el-form-item>
    <el-form-item
      v-if="config.loopType === 'while'"
      label="终止条件"
    >
      <el-input
...
import type { LoopConfig } from '@/types/workflow-nodes'
