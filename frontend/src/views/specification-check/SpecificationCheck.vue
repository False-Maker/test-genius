      ...
      >
        ...
        >
          <el-descriptions-item label="评分">
            {{ checkResult.complianceScore }}
          </el-descriptions-item>

          <el-descriptions-item label="总检查项">
            {{ checkResult.totalChecks }}
          </el-descriptions-item>

          <el-descriptions-item label="通过�">
            {{ checkResult.passedChecks }}
          </el-descriptions-item>
      ...
      >
        ...
        <el-tabs>
          <el-tab-pane label="增强后的用例">
            ...
            >
              <el-descriptions-item label="前置条件">
                {{ injectionResult.enhancedTestCase.preCondition }}
              </el-descriptions-item>

              <el-descriptions-item label="测试步骤">
                {{ injectionResult.enhancedTestCase.testStep }}
              </el-descriptions-item>

              <el-descriptions-item label="预期结果">
                {{ injectionResult.enhancedTestCase.expectedResult }}
              </el-descriptions-item>
            </el-descriptions>
          </el-tab-pane>
          ...
          <el-tab-pane label="应用规约">
            <el-table
              :data="injectionResult.appliedSpecs"
              style="width: 100%"
            >
              <el-table-column
                prop="specCode"
