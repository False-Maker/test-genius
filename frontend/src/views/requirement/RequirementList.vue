      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="需求ID文档" :span="2">
          ...
          <el-link
            ...
            v-if="viewData.requirementDocUrl"


            :href="viewData.requirementDocUrl"
...
const formRules: FormRules = {
  ...
  requirementName: [
    ...
    { max: 500, message: '需求ID名称长度不能超过500个字符', trigger: 'blur' }
  ...
  requirementType: [
    ...
    { required: true, message: '请选择需求ID类型', trigger: 'change' }
...
const handleEdit = async (row: TestRequirement) => {
  ...
  try {
    ...
    console.error('获取需求ID详情失败', error)
...
const handleDelete = async (row: TestRequirement) => {
  ...
  try {
    ...
    await ElMessageBox.confirm(
      ...
      `确定要删除需求ID${row.requirementName}"吗？`,
