      ...
      >
        ...
        <el-col :span="8">
          <div class="recommendation-card speed">
            ...
            >
              <div class="model-name">
                {{ speedModel.modelName }}
              </div>
              <div class="model-code">
                {{ speedModel.modelCode }}
              </div>
              <div class="model-score">
    ...
    >
      ...
      >
        ...
        <el-descriptions-item label="是否推荐">
          <el-tag
            v-if="currentModel.isRecommended === '1'"
            type="success"
            effect="dark"
          >
            推荐
        ...
        <el-descriptions-item label="创建时间">
          {{ formatTime(currentModel.createTime) }}
        </el-descriptions-item>
        <el-descriptions-item label="更新时间">
          {{ formatTime(currentModel.updateTime) }}
        </el-descriptions-item>
      </el-descriptions>
    </el-dialog>
  </div>
