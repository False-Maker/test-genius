...
export const dataDocumentApi = {
  ...
  generateEquivalenceTable(data: EquivalenceTableRequest) {
    return request.post<ApiResult<EquivalenceTableResponse>>('/v1/data-documents/equivalence-tables', data)
  },

  // 生成正交表
  generateOrthogonalTable(data: OrthogonalTableRequest) {
    return request.post<ApiResult<OrthogonalTableResponse>>('/v1/data-documents/orthogonal-tables', data)
  },
