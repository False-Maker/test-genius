...
export const testReportTemplateApi = {
    ...
    createTemplate(data: TestReportTemplateRequestDTO) {
        return request.post<TestReportTemplateResponseDTO>('/v1/test-report-templates', data)
    },
    ...
    getTemplateById(id: number) {
        return request.get<TestReportTemplateResponseDTO>(`/v1/test-report-templates/${id}`)
    },

    // Get template by code
    getTemplateByCode(templateCode: string) {
        return request.get<TestReportTemplateResponseDTO>(`/v1/test-report-templates/code/${templateCode}`)
    },

    // Update template
    updateTemplate(id: number, data: TestReportTemplateRequestDTO) {
        return request.put<TestReportTemplateResponseDTO>(`/v1/test-report-templates/${id}`, data)
    },

    // Delete template
    deleteTemplate(id: number) {
        return request.delete<void>(`/v1/test-report-templates/${id}`)
    },

    // Toggle template status
    toggleTemplateStatus(id: number, isActive: '0' | '1') {
        return request.put<TestReportTemplateResponseDTO>(`/v1/test-report-templates/${id}/status`, null, {
            params: { isActive }
        })
    },
    ...
    setDefaultTemplate(id: number, templateType: string) {
        return request.put<TestReportTemplateResponseDTO>(`/v1/test-report-templates/${id}/default`, null, {
            params: { templateType }
        })
    },
    ...
    getActiveTemplatesByType(templateType: string) {
        return request.get<TestReportTemplateResponseDTO[]>('/v1/test-report-templates/active', {
            params: { templateType }
        })
    },
    ...
    getDefaultTemplateByType(templateType: string) {
        return request.get<TestReportTemplateResponseDTO>('/v1/test-report-templates/default', {
            params: { templateType }
        })
    }
}
