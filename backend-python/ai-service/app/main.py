...
from app.api import (
    ...
    case_reuse_router,
    ui_script_router,
    flow_document_router,
    parameter_extraction_router,
    workflow_router,
    agent_router,
    requirement_router,
)
...
app.include_router(
    flow_document_router.router, prefix="/api/v1/flow-documents", tags=["流程文档"]
)
app.include_router(
    parameter_extraction_router.router,
    prefix="/api/v1/parameter-extraction",
    tags=["参数提取"],
)
...
app.include_router(requirement_router.router, prefix="/api/v1", tags=["需求分析"])
